...
class TestHelperFunctions(TestCase):
    ...
    def test_calculate_directory_files_md5(self):
        ...
        expected_result = [(os.path.join('tmp', 'test1'), 'acbd18db4cc2f85cedef654fccc4a4d8'),
                           (os.path.join('tmp', 'test2'), '37b51d194a7513e45b56f6524f2d51f2')]
        self.assertEqual(expected_result, result)

    def test_calculate_md5_recursively_without_full_path(self):
        result = get_md5_recursively('tmp', full_path=False)
        expected_result = [('test1', 'acbd18db4cc2f85cedef654fccc4a4d8'),
                           ('test2', '37b51d194a7513e45b56f6524f2d51f2'),
    ...
    def test_get_files_recursively_without_full_path(self):
        ...
        expected_result = ['test1', 'test2', os.path.join('test', 'test_subfolder')]
        self.assertEqual(expected_result, result)

    def test_get_files_recursively_with_full_path(self):
        result = directory_files_recursively('tmp', full_path=True)
        expected_result = [os.path.join('tmp', 'test1'),
                           os.path.join('tmp', 'test2'),
